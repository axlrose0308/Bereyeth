...
<form:form action="/admin/modify_organizer" method="POST" class='create-user-form'>
    <table>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="id" name="id" value="${organizer.id}" readonly="readonly" class='seminar-form-input'/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="username" name="username" value="${organizer.username}" readonly="readonly" class='seminar-form-input'/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="password" id="password" name="password" value="${organizer.password}" class='seminar-form-input'/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="password" id="repeatpassword" name="repeatpassword" value="${organizer.password}" class='seminar-form-input'/>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <input type="text" id="email" name="email" value="${organizer.email}" class='seminar-form-input'/>
            </td>
        </tr>
        <tr>
            <td>
